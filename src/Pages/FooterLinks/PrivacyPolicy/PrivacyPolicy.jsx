  ...
  return (
    <LoginLayout>
      ...
      <div className={classes.discription_Wrapper}>
        <h2>Privacy Policy of evangadi.com</h2>
        <p>
        ...
        <p>
          <b>Personalize your experience :</b>We use the information we collect
        ...
        <p>
          <b>Send you messages: </b> We may use the email address you may
          provide on registration to send periodical updates as part of our
          service and notify you of important developments regarding the
          service. The email address you provide may be used to send you
        ...
        <p>
          ...
          supplied information is encrypted before entered into our database to
          be only accessed by those authorized with special access rights to our
        ...
        <p>
          ...
          our website at evangadi.com/legal/terms/
        </p>
        <h3>Your Consent</h3>
